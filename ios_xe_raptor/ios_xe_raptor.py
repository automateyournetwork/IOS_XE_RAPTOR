...
def run_pyats_job():
    os.system("pyats run job ios_xe_raptor_job.py")
...
def page_chat():
    if 'chat_instance' not in st.session_state:
        st.session_state['chat_instance'] = ChatWithIOSXE()
    ...
    user_input = st.text_input("Ask a question about the IOS XE Device:")
